...
var _fetchfunctionsJs = require("./fetchfunctions.js");
var _fetchfunctionsJsDefault = parcelHelpers.interopDefault(_fetchfunctionsJs);
var debounce = require("6b82ad859cabeec1");
...
refs.inputField.addEventListener("input", debounce(displayCountries, DEBOUNCE_DELAY));
function displayCountries(ev) {
    let searchQuery = ev.target.value;
    (0, _fetchfunctionsJsDefault.default)(searchQuery).then((countryInfo)=>createMarkup(countryInfo)).catch((error)=>{
...
function createMarkup(information) {
    if (information.length > 10) (0, _notiflixDefault.default).Notify.info("Too many matches found. Please enter a more specific name.");
    const html = information.map((element)=>{
    ...
    if (information.length === 1) {
        const htmloneElement = information.map((element)=>{
            return `
...
},{"./sass/index.scss":"9OQSl","notiflix":"5z0Oc","6b82ad859cabeec1":"3JP5n","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./fetchfunctions.js":"k3Ipj"}],"9OQSl":[function() {},{}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"k3Ipj":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = fetchcountries;
function fetchcountries(countryName) {
    return fetch(`https://restcountries.com/v2/name/${countryName}?fields=name,flag,capital,languages,population`).then((response)=>{
        return response.json();
    });
}

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jC2qd","8lqZg"], "8lqZg", "parcelRequired7c6")
